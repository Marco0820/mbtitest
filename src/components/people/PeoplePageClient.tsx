...
export default function PeoplePageClient({ initialUsers }: PeoplePageClientProps) {
  ...
  const filteredUsers = useMemo(() => {
    return initialUsers.filter(user => {
      ...
      return (appliedFilters.mbti === 'all' ? true : mbti.startsWith(appliedFilters.mbti)) &&
             ...
             (appliedFilters.searchTerm && user.name ? user.name.toLowerCase().includes(appliedFilters.searchTerm.toLowerCase()) : true);
    });
  }, [appliedFilters, initialUsers]);
